...
# ---------------------------------------------------------------------------
# Phase 1: Training-only return type (no generation/reconstruction)
# ---------------------------------------------------------------------------


@dataclass
class TrainedModel:
    """Training-only output from v2 orchestrators.
...
# =========================================================================
# Phase 1: v2 training wrappers — training only, no generation/reconstruction
# =========================================================================
...
def training_AEs_v2(
    ...
    This is the v2 (training-only) counterpart of :func:`training_AEs`.
    It does **not** perform generation or reconstruction — those are
    ...
    if modelname == "CVAE":
        ...
        raise ValueError("modelname is not supported by training_AEs_v2 function.")
...
def training_GANs_v2(
    ...
    This is the v2 (training-only) counterpart of :func:`training_GANs`.
    It does **not** perform sample generation.
    ...
    if modelname == "GAN":
        ...
        raise ValueError(f"modelname '{modelname}' not supported by training_GANs_v2.")
...
def training_flows_v2(
    ...
    This is the v2 (training-only) counterpart of :func:`training_flows`.
    It does **not** perform sample generation.
